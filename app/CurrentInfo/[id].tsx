...
// import {readFromCache} from "@/lib/cacheUtils";
...
export default function CurrentTempDataScreen() {
    ...
    // const [thermalReadings, setThermalReadings] = useState<object[]>([]);
    // setThermalReadings(useApiData(currentDataKey).filter(room => room.building === building));
    // useEffect(() => {
    //     readFromCache("currentReadings", setThermalReadings);
    // })
