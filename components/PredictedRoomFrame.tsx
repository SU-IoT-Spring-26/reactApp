...
export default function PredictedRoomFrame({room}: { room: SensorData}) {
    ...
    return (
        <LinearGradient colors={["#c3c3c3", "#999999"]}
            ...
            <View style={styles.roomStatusContainer}>
                <Text style={styles.roomStatusWord}>Predicted status in an hour: </Text>
                <Text style={[styles.roomStatus, {backgroundColor: occupied ? "#fa4848" : "#3da129",}]}>
                    {occupied ? "Occupied" : "Empty"}</Text>
            </View>
            {/*<View style={styles.roomStatusContainer}>*/}
            {/*    <Text style={styles.roomStatusWord}>Predicted status this time tomorrow: </Text>*/}
            {/*    <Text style={[styles.roomStatus, {backgroundColor: occupied ? "#fa4848" : "#3da129",}]}>*/}
            {/*        {occupied ? "Occupied" : "Empty"}</Text>*/}
            {/*</View>*/}
